...
export const GET: APIRoute = async () => {
  ...
  const lines = [
    ...
    "",
    "## What Maxxim is",
    "- Maxxim is a commercialisation engine that runs a proven, gated method at AI speed, with an accountable human at every gate.",
    "- Essence: the human at the wheel. It is a method, not a magic box.",
