---
name: taste-skill
description: Anti-slop frontend skill for landing pages, portfolios, and redesigns. Infers design direction from the brief and avoids templated AI defaults. Use for landing page, portfolio, or redesign requests.
---
